...
print(f"The total sum of all the loans are ${total_of_all_loans}")
...
#The loan cost is below its fair value (not factoring risks) and it makes sense to buy at its current cost.
...
# 
def peevee(future_value, remaining_months, annual_discount_rate):
...
present_value = peevee(future_value, remaining_months, annual_discount_rate)
